...
# RDS parameter group
# ---------------
resource "aws_db_parameter_group" "msql_standalone_parametergroup" {
...
resource "aws_db_subnet_group" "mysql_standalone_subnetgroup" {
  ...
  tags = {
    Name    = "${var.project}-${var.environment}-mysql_standalone_subnetgroup"
    Project = var.project
    Env     = var.environment
  }
}
...
resource "aws_db_instance" "mysql_standalone" {
  ...
  name                 = "tastylog"
  parameter_group_name = aws_db_parameter_group.msql_standalone_parametergroup.name
